...
testova aplikacije. Testovi su napisani opet u C++ i koriste samo standardnu
biblioteku C++. Napisani su tako da pokrivaju sve ključne
...
\begin{kljucnerijeci}
    ...
    kriptovalute; C++; Qt; STL; stohastički modeli; financijska analitika;
\end{kljucnerijeci}
...
\begin{keywords}
    ...
    cryptocurrency; C++; Qt; STL; stochastic models; financial analytics;
\end{keywords}
